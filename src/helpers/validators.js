...
const getShapes = ({ star, triangle, circle, square }) => [
  star,
  triangle,
  circle,
  square,
...
const isEqualTriangleToSquare = (shape) =>
  equals(getTriange(shape), getSquare(shape));
const isTriangeNotEqualWhite = (shape) =>
  not(equals(getTriange(shape), "white"));
...
export const validateFieldN10 = allPass([
  isEqualTriangleToSquare,
  isTriangeNotEqualWhite,
]);
